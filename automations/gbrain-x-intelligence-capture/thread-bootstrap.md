...
For initialization, verify that the tracked definition and GBrain destination exist, report readiness, and do not perform the scheduled X collection run. Future heartbeat messages trigger each scheduled run in this same task.
