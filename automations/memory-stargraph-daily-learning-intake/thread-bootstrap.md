...
For initialization, verify readiness and do not perform the scheduled learning-intake run. Future heartbeat messages trigger each scheduled run in this same task.
